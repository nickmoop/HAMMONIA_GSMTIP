...
def create_gsmtip_files_from_hammonia(file_to_read):
    ...
    # стартовое время от которого в HAMMONIA производится отсчет времени.
    # в файле с данными HAMMONIA указана разница во времени
    ...
    for time_index in range(0, len(times)):
        ...
        for latitude in range(-85, 95, 5):
            ...
            for longitude_index, longitude in enumerate(range(5, 365, 5)):
                ...
                density = calculate_air_density(molar_density, temperature)
